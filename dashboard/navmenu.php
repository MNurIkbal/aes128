<div class="wrapper">
  <header class="main-header hidden-print"><a class="logo" href="#" target="_blank" rel="noopener noreferrer" style="font-size:13pt;background-color: #1B4EF5;"><img src="../assets/images/logo.png" width="45px" alt="" srcset=""></a>
  ...
  <aside class="main-sidebar hidden-print" style="background-color: #1B4EF5;">
